...
OBJS := \
  ...
  ./debug/pattern.o	\
  ./debug/i2c.o	\
  ./debug/statemachine_state.o	\
  ./debug/statemachine_table.o	\
  ./debug/temp_sensor.o
...
C_DEPS = \
  ...
  ./debug/pattern.d	\
  ./debug/i2c.d	\
  ./debug/statemachine_state.d	\
  ./debug/statemachine_table.d	\
  ./debug/temp_sensor.d
...
PC_SCRS := \
		...
		./source/pattern.c	\
		./source/i2c.c	\
		./source/statemachine_state.c	\
		./source/statemachine_table.c	\
...
# Project 4 targets
ifeq ($(MAKECMDGOLAS), DEBUG)
	PLATFORM := FB
	CC := arm-none-eabi-gcc
	CC_OPTIONS := -c -std=gnu99 -O0 -g -ffunction-sections -fdata-sections -fno-builtin -mcpu=cortex-m0plus -mthumb -DCPU_MKL25Z128VLK4 -D__USE_CMSIS $(INCLUDES)
	CC_OPTIONS += -DBOARD -DDEBUG -DSDK_DEBUGCONSOLE
	LL := arm-none-eabi-gcc
	LL_OPTIONS := -nostdlib -Xlinker -Map="debug/MyMakeProject.map" -Xlinker --gc-sections -Xlinker -print-memory-usage -mcpu=cortex-m0plus -mthumb -T linkerfile.ld -o $(EXE)
endif

ifeq ($(MAKECMDGOLAS), NORMAL)
	PLATFORM := FB
	CC := arm-none-eabi-gcc
	CC_OPTIONS := -c -std=gnu99 -O0 -g -ffunction-sections -fdata-sections -fno-builtin -mcpu=cortex-m0plus -mthumb -DCPU_MKL25Z128VLK4 -D__USE_CMSIS $(INCLUDES)
	CC_OPTIONS += -DBOARD -DNORMAL -DSDK_DEBUGCONSOLE
	LL := arm-none-eabi-gcc
	LL_OPTIONS := -nostdlib -Xlinker -Map="debug/MyMakeProject.map" -Xlinker --gc-sections -Xlinker -print-memory-usage -mcpu=cortex-m0plus -mthumb -T linkerfile.ld -o $(EXE)
endif

ifeq ($(MAKECMDGOLAS), TEST)
	PLATFORM := FB
	CC := arm-none-eabi-gcc
	CC_OPTIONS := -c -std=gnu99 -O0 -g -ffunction-sections -fdata-sections -fno-builtin -mcpu=cortex-m0plus -mthumb -DCPU_MKL25Z128VLK4 -D__USE_CMSIS $(INCLUDES)
	CC_OPTIONS += -DBOARD -DTEST -DSDK_DEBUGCONSOLE
	LL := arm-none-eabi-gcc
	LL_OPTIONS := -nostdlib -Xlinker -Map="debug/MyMakeProject.map" -Xlinker --gc-sections -Xlinker -print-memory-usage -mcpu=cortex-m0plus -mthumb -T linkerfile.ld -o $(EXE)
endif
...
NORMAL: $(EXE)
	@echo "*** FINISHED BUILDING Normal Version ***"
	
TEST: $(EXE)
	@echo "*** FINISHED BUILDING Test Version ***"
...
./debug/i2c.o: ./source/i2c.c ./source/i2c.h
	@echo 'Building file: $<'
	$(CC) $(CC_OPTIONS) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
./debug/statemachine_state.o: ./source/statemachine_state.c ./source/statemachine_state.h
	@echo 'Building file: $<'
	$(CC) $(CC_OPTIONS) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
	
./debug/statemachine_table.o: ./source/statemachine_table.c ./source/statemachine_table.h
	@echo 'Building file: $<'
	$(CC) $(CC_OPTIONS) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
	
./debug/temp_sensor.o: ./source/temp_sensor.c ./source/temp_sensor.h
	@echo 'Building file: $<'
	$(CC) $(CC_OPTIONS) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
